...
luafile_test() ->
  P=elua:luafile("lua_file_exist.lua"),
  ?assertEqual(true,filelib:is_file(P)).

%% %% luad file base test
%% lua_base_test()->
%%   LuaPath=elua:luafile("lua_file_exist.lua"),
%%   {ok,L}=elua:newstate(),
...
%% %% load lua file.
%% lua_dofile_test()->
%%   LuaPath=elua:luafile("do_file_good.lua"),
%%   Lua1Path=elua:luafile("do_file_bad.lua"),
%%   Lua2Path=elua:luafile("do_file_bad2.lua"),
%%   {ok,L}=elua:newstate(),
%%   ok=elua:dofile(L,LuaPath),
...
%% %% gen call test
%% gen_call_test()->
%%   LuaPath=elua:luafile("gen_call.lua"),
